...
<%@page import="travel.CategoryDao,travel.*,java.util.*"%>  
...
<!-- <br/><a href="adduserform.jsp">Add New User</a>   -->
   ...
   <div class="text-right" style="width:75%">
    <a class="btn btn-primary font-weight-bold" href="javascript:history.back()">Go Back</a>
	            <a class="btn btn-primary font-weight-bold" href="category_form.jsp">Add Category</a>
	        </div>
<div style="padding-top:20px"></div>
<table border="0" width="50%" height="300px" align="center" class="tableshadow" style="padding-top:0px;">
<tr><td class="toptd">Category View</td></tr>
...
<td style="font-size:15px; padding:5px; font-weight:bold;">Category Image</td>
...
<tr><td>${u.getCat_id()}</td><td>${u.getCat_name()}</td><td><img alt="pic1" src="${u.getCat_img_path()}" style="height:50px;width:100px;"></td> 
<td><a href="category_formedit.jsp?cat_id=${u.getCat_id()}">Edit</a></td>  
<td><a href="category_delete.jsp?cat_id=${u.getCat_id()}">Delete</a></td></tr>  
</c:forEach>  
