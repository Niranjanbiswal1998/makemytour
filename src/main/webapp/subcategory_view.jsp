...
<!-- <br/><a href="adduserform.jsp">Add New User</a>   -->
   ...
   <div class="text-right" style="width:75%">
    <a class="btn btn-primary font-weight-bold" href="javascript:history.back()">Go Back</a>
	            <a class="btn btn-primary font-weight-bold" href="subcategory_form.jsp">Add Subcategory</a>
	        </div>
<div style="padding-top:20px"></div>
<table border="0" width="50%" height="300px" align="center" class="tableshadow" style="padding-top:0px;">
<tr><td class="toptd">Subcategory View</td></tr>
<tr><td align="center" valign="top" >
<table border="0" align="center" width="95%" >
<%  
List<Subcategory> list=SubcategoryDao.getAllRecords();  
request.setAttribute("list",list);

%>
<tr><td style="font-size:15px; padding:5px; font-weight:bold;">ID</td>
<td style="font-size:15px; padding:5px; font-weight:bold;">Sub category Name</td>
...
<td style="font-size:15px; padding:5px; font-weight:bold;">Delete</td>
 <%--  <c:set var = "subcat_pic2" value ="${fn:substring(subcat_pic, 29, 59)}"/> --%>
   <%--    SubcatPic<c:out value='${subcat_pic2}' /> <br/> --%>
<c:forEach items="${list}" var="u">  
  <c:set var = "subcat_pic" value ="${u.getSubcat_pic()}"/>
 <%--  ${fn:substring(subcat_pic, 29, 59)}   --%>
<tr><td>${u.getSubcat_id()}</td><td>${u.getSubcat_name()}</td><td>${u.getSubcat_details()}</td><td><img src="${u.getSubcat_pic()}" class="zoom" style="width:100px;height:50px;"></td> 
<td><a href="subcategory_formedit.jsp?subcat_id=${u.getSubcat_id()}">Edit</a></td>  
<td><a href="subcategory_delete.jsp?subcat_id=${u.getSubcat_id()}">Delete</a></td></tr>  
</c:forEach>  
