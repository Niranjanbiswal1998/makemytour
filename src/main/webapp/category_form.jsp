      ...
      <div id="content">
        ...
        <div class="text-right" style="width:75%">
         <a class="btn btn-primary font-weight-bold" href="javascript:history.back()">Go Back</a>
	            ...
	            <a class="btn btn-primary font-weight-bold" href="category_view.jsp">View Category</a>
	        </div>
	        <div style="padding-top:20px"></div>
		<form method="post"  enctype="multipart/form-data" action="CategoyProcess">
		<table border="0" width="50%" height="300px" align="center" class="tableshadow">
		<tr><td colspan="2" class="toptd">Add Category</td></tr>
		<tr><td class="lefttxt">Category Name</td><td><input type="text" name="cat_name" required pattern="[a-zA-z _]{3,20}" title"Please Enter Only Characters between 3 to 10 for Category Name" /></td></tr>
		<tr><td class="lefttxt">Category Image</td><td><input type="file" name="cat_img"  /></td></tr>
