...
<tr><td class="toptd">View Booking List</td></tr>
...
<td style="font-size:15px; padding:5px; font-weight:bold;">Action</td>
...
PreparedStatement ps=con.prepareStatement("select * from tbl_booking");
...
%>
		...
		<td style='padding:5px;'><a href='chstatus.jsp?booking_id=<%out.print(rs.getInt(1)); %>'><%out.print(rs.getString(16)); %></a></td>
		</tr>
