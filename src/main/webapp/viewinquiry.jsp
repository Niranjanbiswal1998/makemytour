...
<td style="font-size:15px; padding:5px; font-weight:bold;" >Reference Id</td>
<td style="font-size:15px; padding:5px; font-weight:bold;">Customer Name</td>
...
<td style="font-size:15px; padding:5px; font-weight:bold;" >Date of Journey</td>
...
PreparedStatement ps=con.prepareStatement("select * from tbl_enquiry");
ResultSet rs=ps.executeQuery();
while(rs.next()){
%>

	
		<td style="padding:5px;"><%out.print(rs.getInt(2)); %></td>
		<td style='padding:5px;'><%out.print(rs.getString(3)); %></td>
		<td style='padding:5px;'><%out.print(rs.getString(4)); %></td>
		<td style='padding:5px;'><%out.print(rs.getString(5)); %></td>
		<td style='padding:5px;'><%out.print(rs.getString(6)); %></td>
		<td style='padding:5px;'><%out.print(rs.getString(7)); %></td>
		<td style='padding:5px;'><%out.print(rs.getString(8)); %></td>
		<td style='padding:5px;'><%out.print(rs.getInt(9)); %></td>
		<td style='padding:5px;'><%out.print(rs.getString(10)); %></td>
		<td style='padding:5px;'><a href='chstatus.jsp?enq_id=<%out.print(rs.getInt(1)); %>'><%out.print(rs.getString(11)); %></a></td>
		</tr>
