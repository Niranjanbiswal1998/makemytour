...
<%-- <%
		...
		PreparedStatement ps0=con0.prepareStatement("select * from  tbl_designation ");
        ResultSet rs0=ps0.executeQuery();
         %>
        <label for="fk_deg_id">Designation :</label>
        <div class="input-container">
        <i class="fa fa-question-circle icon"></i>
        <select class="form-control custom-select" id="fk_deg_id"name="fk_deg_id">
        ...
        <span id="error_fk_deg_id" class="text-danger"></span>
        </div>  --%>
		...
		<form   action="SubCategoryProcess" method="post" enctype="multipart/form-data">
		...
		<tr><td class="lefttxt">Subcategory Name</td><td><input type="text" name="subcat_name"  /></td></tr>
		<tr><td class="lefttxt">Subcat Pic</td><td><input type="file" name="subcat_pic"></td>
		<tr><td class="lefttxt">Subcategory Details</td><td><input type="text" name="subcat_details"   /></td></tr>
		<tr><td>&nbsp;</td><td ><input type="submit" value="SAVE" name="sbmt" class="btn btn-primary font-weight-bold"/> <a class="btn btn-primary font-weight-bold" href="index.html">CANCEL</a></td></tr>
		</table>
		</form>
        </div>
        <!-- /.container-fluid -->
