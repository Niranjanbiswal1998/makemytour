...
<div class="row"style=" margin:auto" >
 ...
 <div class="col-md-9"style="background-color:#ebfff0;float:left;padding-top:20px;">
   <div class="text-center text-white bg-info display1"style="border-bottom:2px solid red;"><h2>Category List</h2></div>
    <div class="row">
      <c:forEach items="${list}" var="u">
        <div class="card-group p-3">
	      <div class="card" style="width:200px;">
	        <a href="subcategory.jsp?cat_id=${u.getCat_id()}" style="text-decoration:none">
               <img class="card-img-top" src="${u.getCat_img_path()}" alt="Card image cap"style="width:198px;height:150px;">
               <div class="card-body bg-info text-white">
               <p class="card-text text-center font-weight-bold ">${u.getCat_name()}</p>
               </div>
             </a>
         </div>
       </div> 
