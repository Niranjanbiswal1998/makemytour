...
<form method="post" enctype="multipart/form-data" action="PackageProcess">
...
<tr><td class="lefttxt">Package Name</td><td><input type="text" name="pack_name" required pattern="[a-zA-z _]{1,50}" title"Please Enter Only Characters between 3 to 50 for Package Name" /></td></tr>
<tr><td class="lefttxt">Package Price</td><td><input type="text" name="pack_price" /></td></tr>
<tr><td class="lefttxt">Upload Pic1</td><td><input type="file" name="pic1Path" /></td></tr>
<tr><td class="lefttxt">Upload Pic2</td><td><input type="file" name="pic2Path" /></td></tr>
<tr><td class="lefttxt">Upload Pic3</td><td><input type="file" name="pic3Path" /></td></tr>
