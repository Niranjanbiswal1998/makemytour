...
<div class="row"style=" margin:auto" >
 ...
 <div class="col-md-9"style="background-color:#ebfff0;float:left;padding-top:20px;">
    <div class="text-center text-white bg-info display1"style="border-bottom:2px solid red;"><h2>Sub Category List</h2></div>
 
    <div class="row">
       <%
       int cat_id=Integer.parseInt(request.getParameter("cat_id"));
       Connection con1=new DBConnection().Connect();
       PreparedStatement ps1=con1.prepareStatement("select * from tbl_subcategory where fk_cat_id="+cat_id+"");
       ResultSet rs1=ps1.executeQuery();
       while(rs1.next()){
       %> 
       <%
       String pic =rs1.getString("subcat_pic");
       //SubcatImages/
		  pic=pic.substring(pic.lastIndexOf("/")-12);
       %>
        <div class="card-group p-3">
	      <div class="card" style="width:200px;">
	        <a href="package.jsp?subcat_id=<%out.print(rs1.getInt(1));%>" style="text-decoration:none">
