<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	<head>
		...
		<body>
				...
				<header class="default-header">
					<nav class="navbar navbar-expand-lg  navbar-light">
						<div class="container">
							  ...
							  <b class="text-white font-weight-bold h-50" >MAKE MY TOUR</b>
							  </a>
							  ...
							  <div class="collapse navbar-collapse justify-content-end align-items-center" id="navbarSupportedContent">
							    <ul class="navbar-nav">
									...
									<li><a href="#tourcategory">Tour Booking</a></li>										
							...
							<div class="row fullscreen justify-content-center align-items-center">
								<div class="col-md-10 col-12">
									<div class="banner-content text-center">
										<h4 class="text-white mb-20 text-uppercase">Discover the Colorful India</h4>
										<h1 class="text-uppercase text-white">Make My Tour</h1>
			...
			<section id="tourcategory">
			<div style="padding-top:80px;"></div>
			  <div class="container-fluid">
			     <iframe src="category.jsp" 
                                height="1300" width="1330"> 
                 </iframe> 
			...
			<footer class="footer-area section-gap">
				<div class="container">
            		...
            		<p class="footer-text">Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://www.opentechz.com" target="_blank">Opentechz Pvt Ltd</a></p>
            		<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
							</div>
						</div>
						<div class="col-lg-5  col-md-6 col-sm-6">
