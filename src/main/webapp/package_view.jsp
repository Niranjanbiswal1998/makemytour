...
<%@ page import="travel.PackageDao,travel.Package,java.util.*" %>
...
<td style="font-size:15px; padding:5px; font-weight:bold;">Delete</td></tr>
<%  
List<Package>list = PackageDao.getAllRecords();  
request.setAttribute("list",list);  
%>  
  
<c:forEach items="${list}" var="u">
<c:set var = "pack_pic1" value ="${u.getPic1Path()}"/> 
<c:set var = "pack_pic2" value ="${u.getPic2Path()}"/> 
<c:set var = "pack_pic3" value ="${u.getPic3Path()}"/>   
<tr><td>${u.getPack_id()}</td>
    <td>${u.getPack_name()}</td>
    <td>${u.getCat()}</td>
    <td>${u.getSubcat()}</td>    
    <td>${u.getPack_price()}</td> 
    <%--  <c:set var = "package_pic1" value ="${fn:substring(pack_pic1, 29, 62)}"/>
      package_pic<c:out value='${package_pic1}' /> <br/> --%>
    <td><img alt="pic1" src="${u.getPic1Path()}" style="height:50px;width:100px;"></td>
    <td><img alt="pic2" src="${u.getPic2Path()}" style="height:50px;width:100px;"></td>
    <td><img alt="pic3" src="${u.getPic3Path()}" style="height:50px;width:100px;"></td>
<td><a href="package_formedit.jsp?pack_id=${u.getPack_id()}">Edit</a></td>  
<td><a href="package_delete.jsp?pack_id=${u.getPack_id()}">Delete</a></td></tr>  
</c:forEach> 
